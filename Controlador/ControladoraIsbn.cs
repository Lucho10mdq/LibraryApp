...
namespace Controlador
{
   public  class ControladoraIsbn
    {
        private RepositorioIsbnBDD ListaIsbn = RepositorioIsbnBDD.GetInstance();
        ...
        {
            Isbn oIsn = new Isbn(ideditorial1,titulo1,nroIsbn);
           Isbn oIsn1 = new Isbn(ideditorial2,titulo2, nroIsbn2);
            Isbn oIsn2 = new Isbn(ideditorial3,titulo2,nroIsb3);
